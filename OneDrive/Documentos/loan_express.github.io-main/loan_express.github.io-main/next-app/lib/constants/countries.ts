// ISO 3166-1 alpha-2 country codes (whitelist for validation)
...
export function isValidCountryCode(code: string): code is CountryCode {
  return VALID_COUNTRIES.includes(code as CountryCode);
}
...
export function getCountryName(code: CountryCode): string {
  const names: Record<CountryCode, string> = {
    ...
    BQ: "Bonaire", BA: "Bosnia and Herzegovina", BW: "Botswana", BR: "Brazil", IO: "British Indian Ocean Territory",
